 ...
 *
 * 矩阵 case:
 *   - case_id: approval_pending_zh_cn_screen_reader
...
test('approval_pending_zh_cn_screen_reader: a11y matrix stub (route=/approvals, state=approval_pending, locale=zh-CN, input_mode=screen_reader)', async () => {
