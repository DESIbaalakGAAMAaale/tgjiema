 ...
 *
 * 矩阵 case:
 *   - case_id: empty_zh_cn_screen_reader
 *   - state: empty
 *   - locale: zh-CN
...
test('empty_zh_cn_screen_reader: a11y matrix stub (route=/notifications, state=empty, locale=zh-CN, input_mode=screen_reader)', async () => {
