 ...
 *
 * 矩阵 case:
 *   - case_id: paginated_en_us_screen_reader
 *   - state: paginated
 *   - locale: en-US
...
test('paginated_en_us_screen_reader: a11y matrix stub (route=/users, state=paginated, locale=en-US, input_mode=screen_reader)', async () => {
