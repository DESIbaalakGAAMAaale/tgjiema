 ...
 *
 * 矩阵 case:
 *   - case_id: permission_denied_zh_cn_keyboard
...
test('permission_denied_zh_cn_keyboard: a11y matrix stub (route=/rbac, state=permission_denied, locale=zh-CN, input_mode=keyboard)', async () => {
