 ...
 *
 * 矩阵 case:
 *   - case_id: approval_approved_en_us_screen_reader
...
test('approval_approved_en_us_screen_reader: a11y matrix stub (route=/approvals, state=approval_approved, locale=en-US, input_mode=screen_reader)', async () => {
