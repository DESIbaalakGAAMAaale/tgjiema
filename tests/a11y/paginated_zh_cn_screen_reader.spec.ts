 ...
 *
 * 矩阵 case:
 *   - case_id: paginated_zh_cn_screen_reader
 *   - state: paginated
 *   - locale: zh-CN
...
test('paginated_zh_cn_screen_reader: a11y matrix stub (route=/users, state=paginated, locale=zh-CN, input_mode=screen_reader)', async () => {
