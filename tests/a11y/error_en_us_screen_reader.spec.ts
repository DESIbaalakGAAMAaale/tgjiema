 ...
 *
 * 矩阵 case:
 *   - case_id: error_en_us_screen_reader
 *   - state: error
 *   - locale: en-US
...
test('error_en_us_screen_reader: a11y matrix stub (route=/readiness, state=error, locale=en-US, input_mode=screen_reader)', async () => {
