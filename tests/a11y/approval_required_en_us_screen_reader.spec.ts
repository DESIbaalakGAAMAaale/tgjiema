 ...
 *
 * 矩阵 case:
 *   - case_id: approval_required_en_us_screen_reader
...
test('approval_required_en_us_screen_reader: a11y matrix stub (route=/approvals, state=approval_required, locale=en-US, input_mode=screen_reader)', async () => {
