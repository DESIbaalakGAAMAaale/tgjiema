 ...
 *
 * 矩阵 case:
 *   - case_id: approval_approved_zh_cn_screen_reader
...
test('approval_approved_zh_cn_screen_reader: a11y matrix stub (route=/approvals, state=approval_approved, locale=zh-CN, input_mode=screen_reader)', async () => {
