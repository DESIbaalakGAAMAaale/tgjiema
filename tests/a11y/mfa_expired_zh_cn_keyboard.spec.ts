 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_expired_zh_cn_keyboard
 *   - state: mfa_expired
 *   - locale: zh-CN
 *   - input_mode: keyboard
 *
...
test('mfa_expired_zh_cn_keyboard: a11y matrix stub (route=/mfa/setup, state=mfa_expired, locale=zh-CN, input_mode=keyboard)', async () => {
