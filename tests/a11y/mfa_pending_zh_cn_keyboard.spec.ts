 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_pending_zh_cn_keyboard
 *   - state: mfa_pending
 *   - locale: zh-CN
 *   - input_mode: keyboard
 *
...
test('mfa_pending_zh_cn_keyboard: a11y matrix stub (route=/mfa/setup, state=mfa_pending, locale=zh-CN, input_mode=keyboard)', async () => {
