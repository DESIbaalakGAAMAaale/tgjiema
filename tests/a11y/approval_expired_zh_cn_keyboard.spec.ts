 ...
 *
 * 矩阵 case:
 *   - case_id: approval_expired_zh_cn_keyboard
...
test('approval_expired_zh_cn_keyboard: a11y matrix stub (route=/approvals, state=approval_expired, locale=zh-CN, input_mode=keyboard)', async () => {
