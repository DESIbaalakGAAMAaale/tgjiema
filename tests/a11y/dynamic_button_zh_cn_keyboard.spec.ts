 ...
 *
 * 矩阵 case:
 *   - case_id: dynamic_button_zh_cn_keyboard
...
test('dynamic_button_zh_cn_keyboard: a11y matrix stub (route=/files, state=dynamic_button, locale=zh-CN, input_mode=keyboard)', async () => {
