 ...
 *
 * 矩阵 case:
 *   - case_id: approval_pending_zh_cn_keyboard
...
test('approval_pending_zh_cn_keyboard: a11y matrix stub (route=/approvals, state=approval_pending, locale=zh-CN, input_mode=keyboard)', async () => {
