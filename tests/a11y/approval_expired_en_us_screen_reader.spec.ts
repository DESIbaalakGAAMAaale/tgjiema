 ...
 *
 * 矩阵 case:
 *   - case_id: approval_expired_en_us_screen_reader
...
test('approval_expired_en_us_screen_reader: a11y matrix stub (route=/approvals, state=approval_expired, locale=en-US, input_mode=screen_reader)', async () => {
