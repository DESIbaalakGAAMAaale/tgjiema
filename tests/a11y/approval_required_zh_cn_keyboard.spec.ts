 ...
 *
 * 矩阵 case:
 *   - case_id: approval_required_zh_cn_keyboard
...
test('approval_required_zh_cn_keyboard: a11y matrix stub (route=/approvals, state=approval_required, locale=zh-CN, input_mode=keyboard)', async () => {
