 ...
 *
 * 矩阵 case:
 *   - case_id: empty_en_us_screen_reader
 *   - state: empty
 *   - locale: en-US
...
test('empty_en_us_screen_reader: a11y matrix stub (route=/notifications, state=empty, locale=en-US, input_mode=screen_reader)', async () => {
