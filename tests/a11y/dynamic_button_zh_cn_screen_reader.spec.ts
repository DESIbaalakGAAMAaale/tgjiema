 ...
 *
 * 矩阵 case:
 *   - case_id: dynamic_button_zh_cn_screen_reader
...
test('dynamic_button_zh_cn_screen_reader: a11y matrix stub (route=/files, state=dynamic_button, locale=zh-CN, input_mode=screen_reader)', async () => {
