 ...
 *
 * 矩阵 case:
 *   - case_id: approval_approved_zh_cn_keyboard
...
test('approval_approved_zh_cn_keyboard: a11y matrix stub (route=/approvals, state=approval_approved, locale=zh-CN, input_mode=keyboard)', async () => {
