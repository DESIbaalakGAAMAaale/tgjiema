 ...
 *
 * 矩阵 case:
 *   - case_id: modal_zh_cn_screen_reader
 *   - state: modal
 *   - locale: zh-CN
...
test('modal_zh_cn_screen_reader: a11y matrix stub (route=/reports, state=modal, locale=zh-CN, input_mode=screen_reader)', async () => {
