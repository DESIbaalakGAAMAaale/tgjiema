 ...
 *
 * 矩阵 case:
 *   - case_id: approval_rejected_zh_cn_screen_reader
...
test('approval_rejected_zh_cn_screen_reader: a11y matrix stub (route=/approvals, state=approval_rejected, locale=zh-CN, input_mode=screen_reader)', async () => {
