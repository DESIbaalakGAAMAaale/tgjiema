 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_expired_en_us_screen_reader
 *   - state: mfa_expired
 *   - locale: en-US
...
test('mfa_expired_en_us_screen_reader: a11y matrix stub (route=/mfa/setup, state=mfa_expired, locale=en-US, input_mode=screen_reader)', async () => {
