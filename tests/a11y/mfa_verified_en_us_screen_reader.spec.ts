 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_verified_en_us_screen_reader
 *   - state: mfa_verified
 *   - locale: en-US
...
test('mfa_verified_en_us_screen_reader: a11y matrix stub (route=/mfa/setup, state=mfa_verified, locale=en-US, input_mode=screen_reader)', async () => {
