 ...
 *
 * 矩阵 case:
 *   - case_id: modal_en_us_screen_reader
 *   - state: modal
 *   - locale: en-US
...
test('modal_en_us_screen_reader: a11y matrix stub (route=/reports, state=modal, locale=en-US, input_mode=screen_reader)', async () => {
