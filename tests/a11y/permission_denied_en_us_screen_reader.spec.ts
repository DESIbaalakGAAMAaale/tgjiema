 ...
 *
 * 矩阵 case:
 *   - case_id: permission_denied_en_us_screen_reader
...
test('permission_denied_en_us_screen_reader: a11y matrix stub (route=/rbac, state=permission_denied, locale=en-US, input_mode=screen_reader)', async () => {
