 ...
 *
 * 矩阵 case:
 *   - case_id: approval_rejected_en_us_screen_reader
...
test('approval_rejected_en_us_screen_reader: a11y matrix stub (route=/approvals, state=approval_rejected, locale=en-US, input_mode=screen_reader)', async () => {
