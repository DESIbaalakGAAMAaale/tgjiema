 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_verified_zh_cn_keyboard
 *   - state: mfa_verified
 *   - locale: zh-CN
 *   - input_mode: keyboard
 *
...
test('mfa_verified_zh_cn_keyboard: a11y matrix stub (route=/mfa/setup, state=mfa_verified, locale=zh-CN, input_mode=keyboard)', async () => {
