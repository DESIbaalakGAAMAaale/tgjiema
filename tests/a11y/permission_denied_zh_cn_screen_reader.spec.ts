 ...
 *
 * 矩阵 case:
 *   - case_id: permission_denied_zh_cn_screen_reader
...
test('permission_denied_zh_cn_screen_reader: a11y matrix stub (route=/rbac, state=permission_denied, locale=zh-CN, input_mode=screen_reader)', async () => {
