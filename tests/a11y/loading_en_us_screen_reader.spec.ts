 ...
 *
 * 矩阵 case:
 *   - case_id: loading_en_us_screen_reader
 *   - state: loading
 *   - locale: en-US
...
test('loading_en_us_screen_reader: a11y matrix stub (route=/tasks, state=loading, locale=en-US, input_mode=screen_reader)', async () => {
