 ...
 *
 * 矩阵 case:
 *   - case_id: loading_zh_cn_screen_reader
 *   - state: loading
 *   - locale: zh-CN
...
test('loading_zh_cn_screen_reader: a11y matrix stub (route=/tasks, state=loading, locale=zh-CN, input_mode=screen_reader)', async () => {
