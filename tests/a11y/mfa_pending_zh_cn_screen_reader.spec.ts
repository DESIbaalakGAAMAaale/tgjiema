 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_pending_zh_cn_screen_reader
 *   - state: mfa_pending
 *   - locale: zh-CN
...
test('mfa_pending_zh_cn_screen_reader: a11y matrix stub (route=/mfa/setup, state=mfa_pending, locale=zh-CN, input_mode=screen_reader)', async () => {
