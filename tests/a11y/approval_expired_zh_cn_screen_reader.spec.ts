 ...
 *
 * 矩阵 case:
 *   - case_id: approval_expired_zh_cn_screen_reader
...
test('approval_expired_zh_cn_screen_reader: a11y matrix stub (route=/approvals, state=approval_expired, locale=zh-CN, input_mode=screen_reader)', async () => {
