 ...
 *
 * 矩阵 case:
 *   - case_id: approval_rejected_zh_cn_keyboard
...
test('approval_rejected_zh_cn_keyboard: a11y matrix stub (route=/approvals, state=approval_rejected, locale=zh-CN, input_mode=keyboard)', async () => {
