 ...
 *
 * 矩阵 case:
 *   - case_id: mfa_expired_zh_cn_screen_reader
 *   - state: mfa_expired
 *   - locale: zh-CN
...
test('mfa_expired_zh_cn_screen_reader: a11y matrix stub (route=/mfa/setup, state=mfa_expired, locale=zh-CN, input_mode=screen_reader)', async () => {
