...
- 本项目共 5 个主进程：up / idx / dsp / mon / admin_bot
  ...
  - **File Bot (file_bot)**：已独立部署至 Cloudflare Workers，零成本、零运维，与主项目 IP 无关联
...
## file_bot 功能
- 独立部署于 Cloudflare Workers，与主项目 IP 无关联
- 仅接收私聊，/start 返回引导文本，其他消息回复「请发送 /start 获取说明」
- 60s 内存防抖，零 CRDB / KV 依赖，完全免费
- 代码目录：`cf-workers/file-bot/`
