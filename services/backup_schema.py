...
BACKUP_SCHEMA: dict[str, TableSchema] = {
    ...
    "users": TableSchema(
        ...
        columns=(
            ...
            "external_quota_date", "is_banned", "ban_expires_at",
            "created_at", "updated_at", "deleted_at", "is_tombstone",
        ),
    ...
    "codes": TableSchema(
        ...
        columns=(
            ...
            "note", "updated_at", "deleted_at", "is_tombstone",
        ),
        conflict_col="code",
